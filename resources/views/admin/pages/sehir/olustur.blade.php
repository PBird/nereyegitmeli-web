            ...
            <div class="card-body">
              ...
              <div class="card card-primary">
                  <div class="card-header">
                    <h3 class="card-title">Yeni Şehir</h3>
                  </div>
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form role="form" id="olusturForm" action="{{route('sehir.store')}}" method="POST" enctype="multipart/form-data">
                  {{csrf_field()}}
                   ...
                   <input type="hidden" id="position" name="position" value="{{ old('position') }}">
                    ...
                    <div class="card-body">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="isim" name="isim" placeholder="Şehir ismi giriniz" value="{{ old('isim') }}">
                      </div>
                      <div class="form-group">
                        <label for="aciklama">Açıklama</label>
                        <input type="text" class="form-control" id="aciklama" name="aciklama" placeholder="Şehire neden gidilmesi gerektiğini anlatan kısa bir cümle giriniz" value="{{ old('aciklama') }}">
                      </div>
               ...
               <div class="form-group form-inline ">
                          ...
                          <input class="form-control mr-2" id="address" type="textbox" value="Türkiye {{ old('isim') }}" onkeydown="if (event.keyCode == 13) { geocodeAddress(geocoder, map);return false;}">

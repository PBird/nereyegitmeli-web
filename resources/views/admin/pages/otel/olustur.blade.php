        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Otel oluştur </li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card-body">
              ...
              <div class="card card-primary">
                  <div class="card-header">
                    <h3 class="card-title">Yeni Otel</h3>
                  </div>
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form role="form" id="olusturForm" action="{{route('otel.store')}}" method="POST" enctype="multipart/form-data">
                  ...
                  <input type="hidden" name="sehir" value="{{$sehir->id}}">
                    <div class="card-body">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="isim" name="isim" placeholder="Otel ismini giriniz" value="{{ old('isim') }}">
                      </div>
                      <div class="form-group">
                          <label>Adres</label>
